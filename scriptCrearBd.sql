...
-- Schema ingsoftware
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `ingsoftware` DEFAULT CHARACTER SET utf8mb3 ;
USE `ingsoftware` ;

-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_persona`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_persona` (
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_usuarios` (
  ...
  CONSTRAINT `fk_tb_usuarios_tb_persona2`
    ...
    REFERENCES `ingsoftware`.`tb_persona` (`idtb_persona`))
ENGINE = InnoDB
AUTO_INCREMENT = 4
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_medicos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_medicos` (
  ...
  CONSTRAINT `fk_tb_medicos_tb_usuarios2`
    ...
    REFERENCES `ingsoftware`.`tb_usuarios` (`idtb_usuarios` , `tb_persona_idtb_persona`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_pacientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_pacientes` (
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_citas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_citas` (
  ...
  CONSTRAINT `fk_tb_citas_tb_medicos2`
    ...
    REFERENCES `ingsoftware`.`tb_medicos` (`idtb_medicos` , `tb_usuarios_idtb_usuarios` , `tb_usuarios_tb_persona_idtb_persona`),
  CONSTRAINT `fk_tb_citas_tb_pacientes2`
    FOREIGN KEY (`tb_pacientes_idtb_pacientes` , `tb_pacientes_tb_persona_idtb_persona`)
    REFERENCES `ingsoftware`.`tb_pacientes` (`idtb_pacientes` , `tb_persona_idtb_persona`))
ENGINE = InnoDB
AUTO_INCREMENT = 2
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_proveedor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_proveedor` (
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_medicamentos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_medicamentos` (
  ...
  CONSTRAINT `fk_tb_medicamentos_tb_proveedor2`
    ...
    REFERENCES `ingsoftware`.`tb_proveedor` (`idtb_proveedor`))
ENGINE = InnoDB
AUTO_INCREMENT = 5
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_movimientosmedicamentos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_movimientosmedicamentos` (
  ...
  CONSTRAINT `fk_tb_movimientosMedicamentos_tb_medicamentos1`
    ...
    REFERENCES `ingsoftware`.`tb_medicamentos` (`idtb_medicamentos`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb3;
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_egresos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_egresos` (
  ...
  CONSTRAINT `fk_tb_egresos_tb_movimientosMedicamentos1`
    ...
    REFERENCES `ingsoftware`.`tb_movimientosmedicamentos` (`idtb_movimientosMedicamentos` , `tb_medicamentos_idtb_medicamentos`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_facturas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_facturas` (
  ...
  CONSTRAINT `fk_tb_facturas_tb_citas2`
    ...
    REFERENCES `ingsoftware`.`tb_citas` (`idtb_citas` , `tb_medicos_idtb_medicos` , `tb_medicos_tb_usuarios_idtb_usuarios` , `tb_medicos_tb_usuarios_tb_persona_idtb_persona` , `tb_pacientes_idtb_pacientes` , `tb_pacientes_tb_persona_idtb_persona`),
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_horarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_horarios` (
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_infopacientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_infopacientes` (
...
-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_ingersos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_ingersos` (
  ...
  CONSTRAINT `fk_tb_ingersos_tb_facturas1`
    ...
    REFERENCES `ingsoftware`.`tb_facturas` (`idtb_facturas`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb3;


-- -----------------------------------------------------
-- Table `ingsoftware`.`tb_personal`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `ingsoftware`.`tb_personal` (
  ...
  CONSTRAINT `fk_tb_personal_tb_horarios1`
    ...
    REFERENCES `ingsoftware`.`tb_horarios` (`idtb_horarios`),
